...
enum class Key : uint32_t
{
    ...
    KP_LEFTPAREN =            0x400000b6u, /**< SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_LEFTPAREN) */
    KP_RIGHTPAREN =           0x400000b7u, /**< SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_RIGHTPAREN) */
    KP_LEFTBRACE =            0x400000b8u, /**< SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_LEFTBRACE) */
    KP_RIGHTBRACE =           0x400000b9u, /**< SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_RIGHTBRACE) */
    ...
    KP_DBLAMPERSAND =         0x400000c8u, /**< SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_DBLAMPERSAND) */
    KP_VERTICALBAR =          0x400000c9u, /**< SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_VERTICALBAR) */
    KP_DBLVERTICALBAR =       0x400000cau, /**< SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_DBLVERTICALBAR) */
...
{
    Left = 1 << (static_cast<int>(MouseButton::Left) - 1),
    Middle = 1 << (static_cast<int>(MouseButton::Middle) - 1),
    Right = 1 << (static_cast<int>(MouseButton::Right) - 1),
    X1 = 1 << (static_cast<int>(MouseButton::X1) - 1),
    X2 = 1 << (static_cast<int>(MouseButton::X2) - 1),
};

constexpr MouseButtonMask MouseButtonToMask(MouseButton button)
{
    return static_cast<MouseButtonMask>(1 << (static_cast<int>(button) - 1));
}
