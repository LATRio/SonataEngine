...
//
// #ifdef _MSC_VER
// #define SN_PROFILE_SCOPE(name) __pragma(warning(suppress:4456)) ::Sonata::InstrumentationTimer timer##__LINE__{(name)}
// #elif
...
#define SN_PROFILE_SCOPE(name) ZoneScopedN(name)
#define SN_PROFILE_FUNCTION ZoneScoped
#define SN_PROFILE_FRAME_MARK FrameMark
#define SN_PROFILE_GPU_CONTEXT TracyGpuContext
#define SN_PROFILE_GPU_ZONE(name) TracyGpuZone(name)
#define SN_PROFILE_GPU_COLLECT TracyGpuCollect
#else
#define SN_PROFILE_SCOPE(name)
#define SN_PROFILE_FUNCTION
#define SN_PROFILE_FRAME_MARK
#define SN_PROFILE_GPU_CONTEXT
#define SN_PROFILE_GPU_ZONE(name)
#define SN_PROFILE_GPU_COLLECT
#endif